...
4. En Java se implementa de la misma manera que vimos en el apartado anterior, lo unico que la instancia que hay que pedir sera la de "AES" en vez de la de "DES". Por lo demás el código sera el mismo.
