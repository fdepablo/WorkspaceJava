...
//quiere decir que ejecutamos todas las queries como si fuera una única (operacion atómica)
...
public class MainTransacciones {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			//por defecto cada vez que lanzamos una modificación (inserte, update, delete...)
