...
public class _00_Conexion {
	...
	public static void main(String[] args) {
		...
		// El driver será usado por jdbc para las conexiones, y dependerá del fabricante
		// de la bbdd y de su versión
		
		// IMPORTANTE: Esto se hacía en versiones de java anteriores a la 1.7 y con drivers
		// antiguos (com.mysql.jdbc.Driver). A fecha actual JAVA carga automaticamente
		// los drivers de conexión (com.mysql.cj.jdbc.Driver). Nótese que sigue siendo
		// necesario cargar el “jar” con las clases de conexión en el “classpath” de java
		/*try {
		...
		// En la cadena de conexión podemos encontrar los siguientes valores
		// jdbc, este es el protocolo de conexión
		// mysql, este es el subprotocolo y tiene con la bbdd
		// localhost, esta es la IP a la que nos queremos conectar
		// 3306, el puerto por el que nos vamos a conectar, por defecto mysql es el 3306
		...
		//Paso 2: crear el objeto que realizará la conexión, este paso habrá que hacerlo
		//tantas veces como queramos acceder a nuestra bbdd
		Connection con = null;
		try {
			//DriverManager es una clase que gestiona las conexiones, y aquí le
		...
		// Aquí irán las “queries”
		
		// Paso 4: Cerrar la conexión (también podríamos poner la referencia con
