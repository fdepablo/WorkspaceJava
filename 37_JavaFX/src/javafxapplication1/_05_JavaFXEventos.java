 ...
 * @author vened
 */
public class _05_JavaFXEventos extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //Tambien con expresiones lambda
        btn2.setOnMouseClicked((event) -> {
            System.out.println("boton pulsado"); 
            System.out.println("La posicion X pulsada es " + event.getSceneX());
            System.out.println("La posicion Y pulsada es " + event.getSceneY());
        });
        
        btn2.setOnMouseEntered((event) -> {
            Button btn = (Button)event.getSource();
            System.out.println("Entrando en el boton con el raton");
            System.out.println("El boton que ha lanzado el evento es: " 
                    + btn.getText());
        });
        
        btn2.setOnMouseExited((event) -> {
            System.out.println("Saliendo en el boton con el raton");
        });
