	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				//Devuelve una descripci�n de la excepci�n. Devuelve null
				//porque el que creo la excepcion no le puso ningun valor
				System.out.println(e.getMessage());
				System.out.println("------------- e.getLocalizedMessage() --------------");
				//ver el ejemplo de 02_personalizadas para m�s detalles
				System.out.println(e.getLocalizedMessage());
				...
				//Muestra el flujo de error est�ndar.
				e.printStackTrace();
				System.out.println("------------- e.printStackTrace(Fichero) --------------");
				try {
					//Muestra el flujo de error est�ndar por un fichero que queramos
