...
class _00_Anotaciones {
	...
	//El ciclo de vida de una clase de pruebas, sera la ejecución de todos los metodos
	...
	//Este método con la anotacion @AfterAll sera ejecutado DESPUES de TODOS los test
	...
	//Este método con la anotacion @BeforeEach sera ejecutado ANTES de cada UNO de los TEST
	//Ejemplo, se ejecutara antes de test1 y antes de test2 (2 veces)
	@BeforeEach
	void setUp() throws Exception {
	}

	//Este método con la anotacion @AfterEach sera ejecutado DESPUES de cada UNO de los TEST
