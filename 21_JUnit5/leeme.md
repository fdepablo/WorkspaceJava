...
El único requisito para que una prueba unitaria resulte efectiva es que tenga 
únicamente dos posibilidades de resolución (correcta/incorrecta). 

Con las pruebas unitarias podemos comparar el resultado aislado de un método, como 
el cálculo de una fórmula matemática que nos retorne un único dato estático. 
Pero también podemos realizar pruebas enviando una serie de datos parametrizados, 
sometiendo al método a realizar operaciones con diferentes rangos y así comprobar 
