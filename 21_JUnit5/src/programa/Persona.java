...
public class Persona {
	...
	/**
	 * Este metodo asiganará el nombre a la propiedad nombre del objeto, pero unicamente cuando
	 * el nombre pasado tenga más de 3 caracteres. En caso contrario se le pondra el valor de 
	 * vacio ("")
	 * 
